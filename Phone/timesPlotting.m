...
hold off
legend({'The mean $DLG$ 1 $\it computational$ $\it complexity$ values','The mean $DLG$ 2 $\it computational$ $\it complexity$ values'},'Interpreter','latex')